...
const UserSampleData_1 = require("../data/UserSampleData");
const User_1 = require("../schemas/User");
let UsersResolver = class UsersResolver {
    constructor() {
        this.items = UserSampleData_1.UserSampleData;
    }
    userByName(name) {
...
__decorate([
    type_graphql_1.Query((returns) => [User_1.default], { nullable: false }),
    __metadata("design:type", Function),
